...
- Initiating population exposure reconstruction of pyrethroids' mixtures from biomonitoring data for risk-based decision making by using toxicokinetic-based high-throughput (HT) and non-HT approaches
